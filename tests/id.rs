...
fn format_it() {
	...
	assert_eq!(dt.formatl("%a", locale).to_string(), "Mg");
	assert_eq!(dt.formatl("%A", locale).to_string(), "Minggu");
	...
	assert_eq!(dt.formatl("%c", locale).to_string(), "Mg Juli  8 00:34:60 2001");
